...
VentureX ERP & CRM is built on Laravel 13.25 (PHP 8.4+), with Blade templates, Alpine.js 3 for interactivity, Tailwind CSS v4 for styling, MySQL 8.0 for data storage, and Vite for asset compilation. It supports Redis for caching and queuing in production.
...
You need PHP 8.4+, MySQL 8.0, a web server (Apache or Nginx), Composer 2.8+, and Node.js 20+. A minimum of 2 GB RAM and 2 GB disk space is required. See [INSTALLATION.md](INSTALLATION.md) for the full list.
