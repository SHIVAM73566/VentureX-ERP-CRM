    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="w-full max-w-3xl">
            ...
            <div class="card overflow-hidden">
                ...
                <form method="POST" action="<?php echo e(route('installer.database.store')); ?>" class="p-6 space-y-5">
                    <?php echo csrf_field(); ?>

                    <?php if($errors->has('db_connection')): ?>
                        <div class="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-800 dark:bg-red-500/10 dark:text-red-400">
                            <?php echo e($errors->first('db_connection')); ?>
                    ...
                    <div class="grid gap-5 sm:grid-cols-3">
                        <div>
                            ...
                            <input id="db_host" name="db_host" type="text" value="<?php echo e(old('db_host', '127.0.0.1')); ?>" class="input" required>
                        </div>
                        <div>
                            <label for="db_port" class="label">Port</label>
                            <input id="db_port" name="db_port" type="number" value="<?php echo e(old('db_port', '3306')); ?>" class="input" min="1" max="65535" required>
                        </div>
                        <div>
                            <label for="db_database" class="label">Database</label>
                            <input id="db_database" name="db_database" type="text" value="<?php echo e(old('db_database', 'VENTUREX_ERP')); ?>" class="input" required>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input id="db_username" name="db_username" type="text" value="<?php echo e(old('db_username', 'root')); ?>" class="input" required>
                        </div>
                        <div>
                            <label for="db_password" class="label">Password</label>
                            <input id="db_password" name="db_password" type="password" value="<?php echo e(old('db_password')); ?>" class="input" placeholder="Leave empty if no password">
                        </div>
                    </div>

                    <div class="flex items-center justify-between pt-2">
                        <a href="<?php echo e(route('installer.welcome')); ?>" class="btn-secondary">← Back</a>
...
<?php /**PATH C:\MY_ERP\resources\views/installer/database.blade.php ENDPATH**/ ?>