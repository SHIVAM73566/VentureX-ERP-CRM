...
<body>
    <div class="header">
        ...
        <div>
            ...
            <div class="doc-number"><?php echo e($quotation->quotation_number); ?></div>
            <div><span class="status status-<?php echo e($quotation->status); ?>"><?php echo e(ucfirst($quotation->status)); ?></span></div>
        </div>
    </div>
    ...
    <div class="info-row">
        <div class="info-block">
            ...
            <div class="info-value">
                <strong><?php echo e($quotation->customer->name ?? 'N/A'); ?></strong><br>
                <?php echo e($quotation->customer->email ?? ''); ?><br>
                <?php echo e($quotation->customer->phone ?? ''); ?><br>
                <?php echo e($quotation->customer->address ?? ''); ?>
        ...
        <div class="info-block" style="text-align: right;">
            ...
            <div class="info-value">
                <strong>Date:</strong> <?php echo e($quotation->created_at->format('d M Y')); ?><br>
                <?php if($quotation->valid_until): ?>
                    <strong>Valid Until:</strong> <?php echo e($quotation->valid_until->format('d M Y')); ?><br>
                <?php endif; ?>
                <strong>Currency:</strong> <?php echo e($quotation->currency_code ?? 'USD'); ?>
    ...
    <table class="totals">
        <tr>
            <td>Subtotal</td>
            <td class="text-right"><?php echo e(number_format($quotation->subtotal, 2)); ?></td>
        </tr>
        <tr>
            <td>Discount</td>
            <td class="text-right">-<?php echo e(number_format($quotation->discount, 2)); ?></td>
        </tr>
        <tr>
            <td>Tax</td>
            <td class="text-right"><?php echo e(number_format($quotation->tax, 2)); ?></td>
        </tr>
        <tr class="total-row">
            <td>Total</td>
            <td class="text-right"><?php echo e(number_format($quotation->total, 2)); ?></td>
        </tr>
    </table>
    ...
    <div class="notes" style="margin-top: 10px;">
        ...
        <div><?php echo e($quotation->terms); ?></div>
    </div>
    <?php endif; ?>
...
<?php /**PATH C:\MY_ERP\resources\views\sales\quotations\pdf.blade.php ENDPATH**/ ?>