...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Customer Support Center','breadcrumbs' => [['label' => 'Support Center']]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Customer Support Center'),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'Support Center']])]); ?>
    ...
    <div class="mx-auto max-w-5xl space-y-6">
        ...
        <div class="rounded-2xl bg-gradient-to-br from-navy-600 to-navy-800 px-8 py-10 text-center text-white">
            ...
            <div class="mt-4 flex items-center justify-center gap-4">
                <a href="<?php echo e(route('support.tickets.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-navy-700 shadow transition hover:bg-navy-50">
                ...
                <a href="<?php echo e(route('support.report-error')); ?>" class="inline-flex items-center gap-2 rounded-lg border border-white/30 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-white/10">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <a href="<?php echo e(route('support.index')); ?>" class="card group flex flex-col items-center gap-3 py-6 text-center transition hover:shadow-md">
            ...
            <a href="<?php echo e(route('support.docs')); ?>" class="card group flex flex-col items-center gap-3 py-6 text-center transition hover:shadow-md">
            ...
            <a href="<?php echo e(route('support.faq')); ?>" class="card group flex flex-col items-center gap-3 py-6 text-center transition hover:shadow-md">
            ...
            <a href="<?php echo e(route('support.contact')); ?>" class="card group flex flex-col items-center gap-3 py-6 text-center transition hover:shadow-md">
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            <a href="<?php echo e(route('support.tickets.index')); ?>" class="card flex items-center gap-4 transition hover:shadow-md">
                ...
                <div>
                    <p class="text-2xl font-bold text-ink-900"><?php echo e($openTickets ?? 0); ?></p>
            ...
            <a href="<?php echo e(route('support.tickets.index')); ?>" class="card flex items-center gap-4 transition hover:shadow-md">
                ...
                <div>
                    <p class="text-2xl font-bold text-ink-900"><?php echo e($pendingReplies ?? 0); ?></p>
                    <p class="text-xs text-ink-500">Awaiting your reply</p>
                </div>
            </a>

            <a href="<?php echo e(route('support.notifications')); ?>" class="card flex items-center gap-4 transition hover:shadow-md">
                ...
                <div>
                    <p class="text-2xl font-bold text-ink-900"><?php echo e($unreadNotifications ?? 0); ?></p>
...
<?php endif; ?>
<?php /**PATH C:\MY_ERP\resources\views\support\index.blade.php ENDPATH**/ ?>