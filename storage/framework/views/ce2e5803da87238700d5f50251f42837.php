...
<head>
    ...
    <title>Send Payment — <?php echo e(config('app.name')); ?></title>
    ...
    <div class="max-w-lg w-full mx-4" x-data="sendPayment()">
        <div class="bg-gray-900 rounded-2xl p-8 shadow-2xl">
            ...
            <div x-show="!success">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" x-model="amount" min="<?php echo e($minAmount); ?>" max="<?php echo e($maxAmount); ?>" step="0.01"
                    ...
                    <p class="text-xs text-gray-500 mt-1">Min: $<?php echo e(number_format($minAmount, 2)); ?> — Max: $<?php echo e(number_format($maxAmount, 2)); ?></p>
                </div>
            ...
            <div x-show="success" class="text-center py-8">
                ...
                <a href="<?php echo e(url('/')); ?>" class="text-blue-400 hover:text-blue-300 underline">Return to dashboard</a>
            </div>
        </div>
    </div>
                ...
                init() {
                    ...
                    paypal.Buttons({
                        ...
                        createOrder: function(data, actions) {
                            ...
                            return fetch('<?php echo e(route("payment.create-custom-order")); ?>', {
                                method: 'POST',
                                headers: {
...
<?php /**PATH C:\MY_ERP\resources\views/paypal/send.blade.php ENDPATH**/ ?>