...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Documentation','breadcrumbs' => [['label' => 'Support', 'url' => route('support.index')], ['label' => 'Documentation']]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Documentation'),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'Support', 'url' => route('support.index')], ['label' => 'Documentation']])]); ?>
            ...
            <div class="space-y-6">
                ...
                <div x-show="activeSection === 'getting-started'" x-transition class="card space-y-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="<?php echo e(route('support.installation')); ?>" class="rounded-lg bg-ink-100 px-3 py-1.5 text-xs font-medium text-ink-700 hover:bg-ink-200">Installation Guide</a>
                        <a href="<?php echo e(route('support.faq')); ?>" class="rounded-lg bg-ink-100 px-3 py-1.5 text-xs font-medium text-ink-700 hover:bg-ink-200">FAQ</a>
                        <a href="<?php echo e(route('support.contact')); ?>" class="rounded-lg bg-ink-100 px-3 py-1.5 text-xs font-medium text-ink-700 hover:bg-ink-200">Contact Support</a>
                    </div>
                </div>
                ...
                <div x-show="activeSection === 'api'" x-transition class="card space-y-4">
                    ...
                    <code class="block rounded-lg bg-ink-900 px-4 py-2 text-xs text-emerald-400"><?php echo e(url('/api/v1')); ?></code>
...
<?php endif; ?>
<?php /**PATH C:\MY_ERP\resources\views/support/docs.blade.php ENDPATH**/ ?>