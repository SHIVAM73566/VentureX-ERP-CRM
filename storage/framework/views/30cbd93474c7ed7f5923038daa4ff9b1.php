...
<head>
    ...
    <title>Session Expired â€” <?php echo e(config('app.name', 'VentureX ERP & CRM')); ?></title>
...
<body class="h-full bg-ink-100 flex items-center justify-center">
    <div class="text-center max-w-md mx-auto px-4">
        <div class="text-7xl font-bold text-ink-300 mb-4">419</div>
        <h1 class="text-2xl font-semibold text-ink-900 mb-2">Session Expired</h1>
        <p class="text-ink-500 mb-8">Your session has expired. Please refresh the page.</p>
...
<?php /**PATH C:\MY_ERP\resources\views/errors/419.blade.php ENDPATH**/ ?>