...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Create Support Ticket','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Create Support Ticket'),'breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Support Center', 'url' => route('support.index')],
        ['label' => 'My Tickets', 'url' => route('support.tickets.index')],
        ['label' => 'Create Ticket'],
    ])]); ?>
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <div class="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3">
            ...
            <div>
                ...
                <p class="text-xs text-amber-700">Many common questions are already answered in our <a href="<?php echo e(route('support.faq')); ?>" class="font-semibold underline hover:text-amber-900">FAQ section</a> and <a href="<?php echo e(route('support.docs')); ?>" class="font-semibold underline hover:text-amber-900">Documentation</a>.</p>
            </div>
        </div>

        
        <form action="<?php echo e(route('support.tickets.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card space-y-5">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select id="category" name="category" required
                            ...
                            <option value="bug" <?php echo e(old('category') === 'bug' ? 'selected' : ''); ?>>Bug Report</option>
                            <option value="feature_request" <?php echo e(old('category') === 'feature_request' ? 'selected' : ''); ?>>Feature Request</option>
                            <option value="question" <?php echo e(old('category') === 'question' ? 'selected' : ''); ?>>Question</option>
                            <option value="installation" <?php echo e(old('category') === 'installation' ? 'selected' : ''); ?>>Installation Issue</option>
                    ...
                    <div>
                        ...
                        <select id="module" name="module"
                            ...
                            <?php $__currentLoopData = ['crm', 'sales', 'procurement', 'inventory', 'logistics', 'finance', 'ai', 'admin', 'auth', 'other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($mod); ?>" <?php echo e(old('module') === $mod ? 'selected' : ''); ?>><?php echo e(ucfirst($mod)); ?></option>
                ...
                <div class="flex items-center justify-between pt-2">
                    <a href="<?php echo e(route('support.tickets.index')); ?>" class="text-sm text-ink-500 hover:text-ink-700">
                        ← Back to My Tickets
                    </a>
...
<?php endif; ?>
<?php /**PATH C:\MY_ERP\resources\views/support/tickets/create.blade.php ENDPATH**/ ?>