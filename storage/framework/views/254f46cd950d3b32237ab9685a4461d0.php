            ...
            <div class="card overflow-hidden text-center">
                <div class="p-8">
                    ...
                    <div class="mt-8 space-y-3">
                        <a href="<?php echo e(route('login')); ?>" class="btn-accent inline-flex items-center gap-2 px-6 py-2.5">
                    ...
                    <div class="mt-6 text-xs text-ink-400 dark:text-ink-500">
                        <p>Installed: <?php echo e(now()->format('M d, Y H:i')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\MY_ERP\resources\views\installer\complete.blade.php ENDPATH**/ ?>