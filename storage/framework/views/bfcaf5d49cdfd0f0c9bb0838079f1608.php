...
<head>
    ...
    <title>Forgot Password â€” <?php echo e(config('app.name', 'VentureX ERP & CRM')); ?></title>
    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-ink-200 bg-white shadow-xl lg:grid-cols-2">
            ...
            <div class="p-8 sm:p-10">
                ...
                <p class="mt-1 text-sm text-ink-500">Enter your email and we'll send you a link to reset your password.</p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="mt-8 text-center text-sm text-ink-500">
                    <a href="<?php echo e(route('login')); ?>" class="font-medium text-accent-600 hover:text-accent-700">&larr; Back to login</a>
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\MY_ERP\resources\views\auth\passwords\email.blade.php ENDPATH**/ ?>