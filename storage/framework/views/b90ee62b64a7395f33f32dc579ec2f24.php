...
<body class="h-full bg-ink-100 dark:bg-ink-950">
            ...
            <div class="card overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div id="success-box" class="mt-6 hidden text-center">
                        <a href="<?php echo e(route('installer.complete')); ?>" class="btn-accent">Continue to Dashboard â†’</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function runInstaller() {
            ...
            try {
                const response = await fetch('<?php echo e(route("installer.execute")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\MY_ERP\resources\views/installer/install.blade.php ENDPATH**/ ?>