...
<head>
    ...
    <title>Sign in â€” <?php echo e(config('app.name', 'VentureX ERP & CRM')); ?></title>
    <script>
        ...
        <div class="grid w-full max-w-5xl overflow-hidden rounded-2xl border border-ink-200 bg-white shadow-xl lg:grid-cols-2 dark:border-ink-800 dark:bg-ink-900">
            ...
            <div class="p-8 sm:p-10">
                <div class="mb-8 lg:hidden">
                    ...
                    <h1 class="mt-4 text-xl font-bold text-ink-900 dark:text-ink-50"><?php echo e(config('app.name')); ?></h1>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="mt-8 space-y-5">
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="email" placeholder="you@company.com" class="input">
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-accent-600 hover:text-accent-700 dark:text-accent-400 dark:hover:text-accent-300">Forgot password?</a>
                    </div>
...
<?php /**PATH C:\MY_ERP\resources\views\auth\login.blade.php ENDPATH**/ ?>