...
<head>
    ...
    <title>Page Not Found â€” <?php echo e(config('app.name', 'VentureX ERP & CRM')); ?></title>
...
<body class="h-full bg-ink-100 flex items-center justify-center">
    <div class="text-center max-w-md mx-auto px-4">
        <div class="text-7xl font-bold text-ink-300 mb-4">404</div>
        <h1 class="text-2xl font-semibold text-ink-900 mb-2">Page Not Found</h1>
        <p class="text-ink-500 mb-8">The page you're looking for doesn't exist or has been moved.</p>
...
<?php /**PATH C:\MY_ERP\resources\views/errors/404.blade.php ENDPATH**/ ?>