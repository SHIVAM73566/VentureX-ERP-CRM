...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Business Copilot','breadcrumbs' => [['label' => 'AI Center'], ['label' => 'Business Copilot']]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Business Copilot','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'AI Center'], ['label' => 'Business Copilot']])]); ?>
        ...
        function copilot() {
            return {
                ...
                async ask(text) {
                    ...
                    try {
                        const res = await fetch(<?php echo json_encode(route('ai.copilot.ask'), 15, 512) ?>, {
                            method: 'POST',
                            body: payload,
...
<?php endif; ?>
<?php /**PATH C:\MY_ERP\resources\views/ai/copilot.blade.php ENDPATH**/ ?>