...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Payment Cancelled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Payment Cancelled']); ?>
    <div class="flex items-center justify-center min-h-[60vh]">
        <div class="max-w-md w-full text-center">
            <div class="bg-white dark:bg-ink-900 rounded-2xl border border-ink-200 dark:border-ink-800 p-8 shadow-lg">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('pricing')); ?>" class="block w-full rounded-lg bg-blue-600 hover:bg-blue-700 px-4 py-3 text-sm font-semibold text-white transition">
                        Try Again
                    </a>
...
<?php endif; ?>
<?php /**PATH C:\MY_ERP\resources\views/pricing/cancel.blade.php ENDPATH**/ ?>