<x-layouts.app
    ...
    :breadcrumbs="[['label' => 'Support', 'url' => route('support.index')], ['label' => 'Installation Guide']]">
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <div class="text-center">
            ...
            <a href="{{ route('support.contact') }}" class="mt-1 inline-flex items-center gap-1 text-sm font-medium text-navy-600 hover:text-navy-500">
