...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> — CRM + ERP + AI Business Operating System</title>
    ...
    <meta property="og:title" content="<?php echo e(config('app.name')); ?> — CRM + ERP + AI Business Operating System">
    ...
    <meta name="twitter:title" content="<?php echo e(config('app.name')); ?> — CRM + ERP + AI">
...
<body class="h-full bg-ink-100 text-ink-800 antialiased">
    ...
    <footer class="border-t border-ink-200 bg-white">
        <div class="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-4 py-6 text-sm text-ink-400 sm:flex-row sm:px-6">
            <p>Â© <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> — Universal CRM + ERP + AI Business Operating System</p>
