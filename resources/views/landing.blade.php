    ...
    <header class="border-b border-ink-200 bg-white">
        <nav class="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6" aria-label="Main">
            <div class="flex items-center gap-2.5">
                ...
                <span class="text-sm font-bold text-ink-900">{{ config('app.name') }}</span>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="rounded-xl overflow-hidden shadow-lg border border-ink-200">
                        <img src="{{ asset('screenshots/Product demo/02-dashboard-desktop.png') }}" alt="Dashboard" class="w-full h-auto">
                    </div>
                    <div class="rounded-xl overflow-hidden shadow-lg border border-ink-200">
                        <img src="{{ asset('screenshots/Product demo/03-customers.png') }}" alt="CRM Customers" class="w-full h-auto">
                    </div>
                    <div class="rounded-xl overflow-hidden shadow-lg border border-ink-200">
                        <img src="{{ asset('screenshots/Product demo/05-opportunities.png') }}" alt="Sales Pipeline" class="w-full h-auto">
                    </div>
                    <div class="rounded-xl overflow-hidden shadow-lg border border-ink-200">
                        <img src="{{ asset('screenshots/Product demo/07-purchase-orders.png') }}" alt="Purchase Orders" class="w-full h-auto">
                    </div>
                    <div class="rounded-xl overflow-hidden shadow-lg border border-ink-200">
                        <img src="{{ asset('screenshots/Product demo/13-ai-quotas.png') }}" alt="AI Features" class="w-full h-auto">
                    </div>
                    <div class="rounded-xl overflow-hidden shadow-lg border border-ink-200">
                        <img src="{{ asset('screenshots/Product demo/17-dashboard-mobile.png') }}" alt="Mobile View" class="w-full h-auto">
                    </div>
                </div>
            </div>
        </section>
