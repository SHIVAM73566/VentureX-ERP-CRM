<x-layouts.app
    ...
    :breadcrumbs="[['label' => 'Support', 'url' => route('support.index')], ['label' => 'FAQ']]">
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <div class="card text-center">
            ...
            <div class="mt-4 flex items-center justify-center gap-3">
                <a href="{{ route('support.contact') }}" class="btn-accent">Contact Support</a>
                <a href="{{ route('support.tickets.create') }}" class="btn-secondary">Submit a Ticket</a>
            </div>
        </div>
    </div>
</x-layouts.app>
